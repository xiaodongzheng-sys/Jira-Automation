...
class WebPortalFeatureTests(unittest.TestCase):
    ...
    def test_index_shows_team_default_admin_tab_only_for_admin_user(self):
        ...
        self.assertIn(b'>Version Plan<', user_response.data)
        self.assertIn(b'href="https://app.bankpmtool.uk/version-plan"', user_response.data)
        self.assertNotIn(b">Projects<", user_response.data)
        ...
        self.assertEqual(user_source_direct_response.status_code, 200)
        ...
        # Signed-in non-admins see the top-level Version Plan, but not admin-only Projects.
        self.assertIn(b">Version Plan<", user_prd_denied_page.data)
        ...
        self.assertIn(b'href="https://app.bankpmtool.uk/version-plan"', sophia_response.data)
        self.assertNotIn(b">Projects<", sophia_response.data)
    ...
    def test_team_dashboard_is_standalone_page_for_admin_user(self):
        ...
        self.assertNotIn(b"Monthly Report Template", dashboard_response.data)
        ...
        self.assertIn(b'data-team-dashboard-tab="report-intelligence"', reports_response.data)
        self.assertIn(b'data-team-dashboard-tab="seatalk-name-mapping"', reports_response.data)
        self.assertIn(b'data-team-dashboard-panel="seatalk-name-mapping"', reports_response.data)
        ...
        self.assertIn(b'data-team-dashboard-panel="version-plan"', sophia_dashboard_response.data)
    ...
    def test_team_dashboard_version_plan_frontend_uses_sheet_format(self):
        ...
        self.assertIn("versionPlanRowMutationInFlight", script)
        self.assertIn("isVersionPlanRowChangesPaused", script)
        self.assertIn("Saving Version Plan changes. Please wait until the current change finishes.", script)
        self.assertIn("beginVersionPlanRowMutation", script)
        self.assertIn("mutationStarted", script)
        self.assertIn("renderOnSuccess: true", script)
        self.assertIn("team-dashboard:version-plan:collapsed:v1", script)
        self.assertIn("data-version-plan-bundle-toggle", script)
        self.assertIn("data-version-plan-bundle-body", script)
        self.assertIn("aria-expanded", script)
        self.assertIn("team-dashboard-version-plan-cell-drag", script)
        self.assertIn("team-dashboard-version-plan-drag", script)
        ...
        self.assertIn("versionPlanPmFilterOptions = ['All PMs', '-', 'Wang Chang', 'Zoey', 'Jireh', 'Ker Yin', 'Rene', 'Jun Wei', 'Xiaodong', 'Sabrina', 'Wei Lin']", script)
    ...
    def test_vpn_connection_frontend_does_not_show_command_finished_as_success(self):
        ...
        self.assertIn("isTransientLocalAgentError", script)
        self.assertIn("refreshProfilesAfterInterruptedConnect", script)
        self.assertIn("refreshProfilesAfterTransientLoad", script)
        self.assertIn("Temporary local-agent tunnel issue. Retrying Cisco status", script)
        self.assertIn("Still retrying Cisco status automatically", script)
        self.assertIn("scheduleStatusRetry", script)
        self.assertIn("visibilitychange", script)
        self.assertIn("vpnConnectionLastProfileId", script)
        self.assertIn("Connection response was interrupted while Cisco changed network", script)

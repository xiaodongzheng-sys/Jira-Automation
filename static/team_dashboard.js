(() => {
  ...
  const versionPlanPmOptions = (selectedValue = '') => {
    ...
    const options = Array.isArray(versionPlanState?.pm_options) && versionPlanState.pm_options.length
      ...
      : ['Wang Chang', 'Zoey', 'Jireh', 'Ker Yin', 'Rene', 'Jun Wei', 'Xiaodong', 'Sabrina', 'Wei Lin'];
  ...
  const versionPlanPmFilterOptions = ['All PMs', '-', 'Wang Chang', 'Zoey', 'Jireh', 'Ker Yin', 'Rene', 'Jun Wei', 'Xiaodong', 'Sabrina', 'Wei Lin'];

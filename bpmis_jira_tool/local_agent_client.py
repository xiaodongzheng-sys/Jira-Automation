...
class LocalAgentClient:
    ...
    def meeting_recorder_process_start(
        self,
        *,
        record_id: str,
        owner_email: str,
        ...
        return self._request(
            ...
            "/api/local-agent/meeting-recorder/process-async",
            {
                ...
                "send_email_on_complete": bool(send_email_on_complete),
            },
        )
    ...
    def work_memory_recent(
        ...
        *,
        ...
        payload = self._request(
            "POST",
            "/api/local-agent/work-memory/recent",
            {
                "owner_email": owner_email,
    ...
    def work_memory_review_candidates(self, *, owner_email: str, limit: int = 50) -> list[dict[str, Any]]:
        payload = self._request("POST", "/api/local-agent/work-memory/review-candidates", {"owner_email": owner_email, "limit": limit})
        items = payload.get("items")
        return items if isinstance(items, list) else []
    ...
    def work_memory_project_timeline(
        ...
        *,
        ...
        payload = self._request(
            "POST",
            "/api/local-agent/work-memory/project-timeline",
            {
    ...
    def work_memory_entity_resolution(self, *, query: str, owner_email: str, entity_type: str = "") -> dict[str, Any]:
        return self._request(
            "POST",
            "/api/local-agent/work-memory/entity-resolution",
            {"query": query, "owner_email": owner_email, "entity_type": entity_type},
        )
    ...
    def work_memory_distill(
        ...
        *,
        ...
        return self._request(
            "POST",
            "/api/local-agent/work-memory/distill",
            {
                "owner_email": owner_email,
    ...
    def work_memory_backfill_existing(
        ...
        *,
        ...
        return self._request(
            "POST",
            "/api/local-agent/work-memory/backfill-existing",
            {"owner_email": owner_email, "date_range": date_range, "sources": sources or []},
        )

    def work_memory_ingest_incremental(self, *, owner_email: str, window: str = "7d", reconciliation: bool = False) -> dict[str, Any]:
        return self._request(
            "POST",
            "/api/local-agent/work-memory/ingest-incremental",
            {"owner_email": owner_email, "window": window, "reconciliation": bool(reconciliation)},
        )

    def superagent_health(self, *, owner_email: str) -> dict[str, Any]:
        return self._request("POST", "/api/local-agent/superagent/health", {"owner_email": owner_email})
    ...
    def superagent_query(
        ...
        *,
        ...
        return self._request(
            "POST",
            "/api/local-agent/superagent/query",
            {
                "owner_email": owner_email,
    ...
    def superagent_explain(self, *, owner_email: str, query: str, task_type: str = "general", visibility_scope: str = "owner") -> dict[str, Any]:
        return self._request(
            "POST",
            "/api/local-agent/superagent/explain",
            {"owner_email": owner_email, "query": query, "task_type": task_type, "visibility_scope": visibility_scope},
        )

    def superagent_eval(self, *, owner_email: str, cases: list[dict[str, Any]] | None = None, limit: int = 30, suite_id: str = "") -> dict[str, Any]:
        return self._request(
            "POST",
            "/api/local-agent/superagent/eval",
...
class RemoteBPMISClient:
    ...
    def update_biz_project_status(self, project_issue_id: str | int, status: str) -> dict[str, Any]:
        return self._call("update_biz_project_status", project_issue_id, status) or {}

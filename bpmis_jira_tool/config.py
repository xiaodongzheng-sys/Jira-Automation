...
class Settings:
    ...
    meeting_recorder_transcript_segment_workers: int = 2
    ...
    meeting_recorder_reminder_enabled: bool = False
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            ...
            meeting_recorder_transcript_segment_workers=_env_int("MEETING_RECORDER_TRANSCRIPT_SEGMENT_WORKERS", 2),
            ...
            meeting_recorder_reminder_enabled=_env_bool("MEETING_RECORDER_REMINDER_ENABLED", False),
